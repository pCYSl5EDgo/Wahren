...
public struct ActionInfo
{
    ...
    public static readonly ActionInfo[] Normals = new ActionInfo[]
    {
        ...
        new("addTroop", 5, 5, SUni, NumReader, NumReader, NumReader, ReferenceKind.RedBlue),
        ...
        new("closeGoal", 0, 0),
        new("ctrlTroop", 1, 1, SUni),
        new("entryItem", 1, 1, SSki),
        new("equipItem", 2, 3),
        new("eraseItem", 1, 1, SSki),
        new("eraseUnit", 1, 1, SUni),
        new("formTroop", 2, 2, SUni, NumReader),
        new("freeTroop", 1, 1, SUni),
        new("haltTroop", 1, 1, SUni),
        new("hideBlind", 0, 0),
        ...
        new("eraseUnit2", 2, int.MaxValue),
        new("eraseTroop", 1, 1, SUni),
        ...
        new("shiftTroop", 3, 4, SUni, NumReader, NumReader, ReferenceKind.Boolean),
        new("shuffleVar", 1, 1, ReferenceKind.StringVariableReader),
        new("skillTroop", 3, 3),
        new("sleepTroop", 1, 1, SUni),
        new("smoveTroop", 2, 2, SUni, SUni),
        new("speedTroop", 2, 2, SUni, NumReader),
        new("unionPower", 2, 2, SPow, SPow),
        new("activeTroop", 1, 1, SUni),
        ...
        new("addPowerMerce", 2, int.MaxValue, SPow, SUni),
        new("addPowerStaff", 2, int.MaxValue, SPow, SUni | ReferenceKind.Class),
        ...
        new("smoveTroopFix", 2, 2, SUni, SUni),
        ...
        new("addPowerMerce2", 2, int.MaxValue, SPow, SUni),
        new("addPowerStaff2", 2, int.MaxValue, SPow, SUni | ReferenceKind.Class),
        new("changePowerFix", 2, 2),
        new("eraseUnitTroop", 1, 1, SUni),
        ...
        new("storeUnitOfPower", 2, 2, SUni, ReferenceKind.StringVariableWriter),
