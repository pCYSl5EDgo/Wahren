...
public struct ElementInfo
{
    ...
    internal static readonly ElementInfo[] Object = new ElementInfo[]
    {
        new("skill"),
        new("front"),
        new("width", referenceKind: ReferenceKind.Number),
        new("height", referenceKind: ReferenceKind.Number),
        new("alpha", referenceKind: ReferenceKind.Number),
        new("type"),
        new("breakfire"),
        new("color", referenceKind: ReferenceKind.Number),
    ...
    internal static readonly ElementInfo[] UnitFallthroughClass = new ElementInfo[]
    {
        ...
        new("active", referenceKind: ReferenceKind.Special),
        new("activenum"),
    ...
    internal static readonly ElementInfo[] Unit = System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Concat(UnitFallthroughClass, new ElementInfo[]
    {
        ...
        new("staff", referenceKind: ReferenceKind.Race | ReferenceKind.Class),
        new("diplomacy", referenceKind: ReferenceKind.Boolean),
        new("castle_guard", referenceKind: ReferenceKind.Unit | ReferenceKind.Class),
    ...
    internal static readonly ElementInfo[] Class = System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Concat(UnitFallthroughClass, new ElementInfo[]
    {
        ...
        new("friend_ex", referenceKind: ReferenceKind.Race | ReferenceKind.Class | ReferenceKind.Unit),
        // new("samecall_baseup"),
    }));
    ...
    internal static readonly ElementInfo[] Power = new ElementInfo[]
    {
        ...
        new("staff", referenceKind: ReferenceKind.Unit | ReferenceKind.ClassTypeReader),
        ...
        new("head", referenceKind: ReferenceKind.Text),
        new("head2", referenceKind: ReferenceKind.Text),
        new("head3", referenceKind: ReferenceKind.Text),
        new("head4", referenceKind: ReferenceKind.Text),
        new("head5", referenceKind: ReferenceKind.Text),
        new("head6", referenceKind: ReferenceKind.Text),
        new("diff", referenceKind: ReferenceKind.Text),
        new("yabo", referenceKind: ReferenceKind.Number),
        new("kosen", referenceKind: ReferenceKind.Number),
        new("text", referenceKind: ReferenceKind.Text),
        new("member", referenceKind: ReferenceKind.Spot),
        new("friend", referenceKind: ReferenceKind.Scenario),
        new("master2", referenceKind: ReferenceKind.Text),
        new("master3", referenceKind: ReferenceKind.Text),
        new("master4", referenceKind: ReferenceKind.Text),
        new("master5", referenceKind: ReferenceKind.Text),
        new("master6", referenceKind: ReferenceKind.Text),
        new("enable"),
    ...
    internal static readonly ElementInfo[] Scenario = new ElementInfo[]
    {
        ...
        new("discus"),
        new("save_name", referenceKind: ReferenceKind.Text),
        new("enable_select"),
        ...
        new("sortkey", referenceKind: ReferenceKind.Number),
        new("default_ending", referenceKind: ReferenceKind.Boolean),
        new("power_order", referenceKind: ReferenceKind.Special),
        new("enable", referenceKind: ReferenceKind.Boolean),
        new("enable_talent", referenceKind: ReferenceKind.Boolean),
        new("party", referenceKind: ReferenceKind.Boolean),
        new("no_autosave", referenceKind: ReferenceKind.Boolean),
        new("zone"),
        new("nozone", referenceKind: ReferenceKind.Boolean),
        new("item0", referenceKind: ReferenceKind.Boolean | ReferenceKind.Number),
        new("item1", referenceKind: ReferenceKind.Boolean | ReferenceKind.Number),
        new("item2", referenceKind: ReferenceKind.Boolean | ReferenceKind.Number),
        new("item3", referenceKind: ReferenceKind.Boolean | ReferenceKind.Number),
        new("item4", referenceKind: ReferenceKind.Boolean | ReferenceKind.Number),
        new("item5", referenceKind: ReferenceKind.Boolean | ReferenceKind.Number),
        new("item6", referenceKind: ReferenceKind.Boolean | ReferenceKind.Number),
        new("item_limit", referenceKind: ReferenceKind.Boolean),
        new("poli"),
        new("camp"),
        new("multi"),
        new("item"),
        new("item_sale", referenceKind: ReferenceKind.Skill),
        new("item_hold", referenceKind: ReferenceKind.Skill),
        new("text", referenceKind: ReferenceKind.Text),
