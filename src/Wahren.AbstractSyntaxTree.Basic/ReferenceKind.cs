...
public enum ReferenceKind : ulong
{
    ...
    StringVariable      = 0x00100000UL,
    GlobalVariable      = 0x00200000UL,
    Number              = 0x00400000UL,
    FloatingNumber      = 0x00800000UL,
    Text                = 0x01000000UL,
    Boolean             = 0x02000000UL,
    FieldAttributeType  = 0x04000000UL,
    FieldId             = 0x08000000UL,
}
